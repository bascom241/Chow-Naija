...
import { emailContent } from "../templates/emailTemplate.js";
dotenv.config();

const sendEmail = async (to,verificationToken,userName) => {
  try {
    ...
    sendSmtpEmail.htmlContent =  emailContent(userName, verificationToken);
...
const sendPasswordResetEmail = async(to,userName, resetLink) => {
    try {
        ...
        sendSmtpEmail.htmlContent =  resetPasswordEmailContent(userName, resetLink);
